...
* `AGGREGATOR_SECRET` -- A bearer token that will be sent in an Authorization header with all aggregator-api requests. Please note that this value must be valid base64. When running in development/api mock mode, this is ignored
