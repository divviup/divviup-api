            ...
            return {
              task: (async (): Promise<Task> => {
                return {
                  id: taskId,
                  name: "Counter task",
                  leader_aggregator_id: "00000000-0000-0000-0000-00000000000a",
                  helper_aggregator_id: "00000000-0000-0000-0000-00000000000b",
                  vdaf: { type: "count" },
                  min_batch_size: 100,
              ...
              collectorCredential: (async (): Promise<CollectorCredential> => {
                return {
